...
export class InitialDatabase1763136026796 implements MigrationInterface {
    name = 'InitialDatabase1763136026796'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`info_personal\` ADD \`profile_image_mimetype\` varchar(50) NULL`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` CHANGE \`id\` \`id\` bigint NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` DROP PRIMARY KEY`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`info_personal\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
        ...
        await queryRunner.query(`ALTER TABLE \`info_personal\` CHANGE \`gender\` \`gender\` enum ('male', 'female', 'other', 'not_specified') NOT NULL DEFAULT 'not_specified'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`info_personal\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`info_personal\` ADD \`id\` bigint NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` CHANGE \`id\` \`id\` bigint NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`info_personal\` DROP COLUMN \`profile_image_mimetype\``);
    }
